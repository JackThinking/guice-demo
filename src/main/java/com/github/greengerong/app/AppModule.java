...
/**
 * *************************************** * Auth: green gerong                     * Date: 2014
 *                         * blog: http://greengerong.github.io/    * github:
...
public class AppModule extends AbstractModule {
  ...
  public void configure() {
    ...
    //TODO: Multibinder2
    final Multibinder<ItemService> itemServiceMultibinder = Multibinder.newSetBinder(binder,
        ItemService.class);
  ...
  @Singleton
  @Named("kkv")
  public Set<ItemService> getAllNameServices(@Named("1") ItemService itemService1,
      @Named("2") ItemService itemService2, @Named("3") ItemService itemService3) {
