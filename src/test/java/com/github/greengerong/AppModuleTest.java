...
public class AppModuleTest {
  ...
  public void should_get_order_service_from_guice_module() throws Exception {
    ...
    final List<ItemService> itemServices = Lists.newArrayList(
        ((OrderServiceImpl) instance).getItemServices());
    ...
    final List<NamedService> namedServices = Lists.newArrayList(
        ((OrderServiceImpl) instance).getNamedServices());
